...
game_teams = [('mia','cha')]#, ('ind','det'), ('cle','orl'), ('wsh','phi'), ('den','atl'), ('tor','nyk'), ('sas','hou'), ('dal','mem'), ('chi','mil'), ('min','nop'), ('uta','okc'), ('bkn','sac'), ('por','lac')]#, ('nop','lal')
...
players_names = ['tyler herro'] # use for testing
